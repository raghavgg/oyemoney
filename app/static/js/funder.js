(function() {
  function embed () {
    ...
    function trackUplift() {
      try {
        var url = 'https://codefund.io/impressions/5ae41c71-c6e5-4de8-812b-869d42c8c055/uplift?advertiser_id=185';
    ...
    try {
      ...
      codeFundElement.innerHTML = '<div id="cf" style="font-family: Helvetica, Arial, sans-serif; font-size: 13px;"> <span class="cf-wrapper" style="box-sizing: border-box; position: fixed; bottom: 0; left: 0; z-index: 5000; width: 100%; border-top-width: 1px; border-top-color: #bfbfbf; border-top-style: solid; background-color: #eeeeee; text-align: center; line-height: 1.5; padding: 0.8em 1em 1em;"> <a data-href="campaign_url" class="cf-text" target="_blank" rel="sponsored noopener" style="box-shadow: none !important; color: rgba(0, 0, 0, 0.8); text-decoration: none;"> <strong>Want to reach our audience?</strong> <span>Learn more about placing ethical ads on this site.</span> </a> <a href="https://app.codefund.io" data-target="powered_by_url" class="cf-powered-by" target="_blank" rel="sponsored noopener" style="box-shadow: none !important; font-size: 12px; text-decoration: none; color: #999;"> <em>ethical</em> ad by CodeFund <img data-src="impression_url" alt=""> </a> </span> </div> <style>#cf .cf-text:before { margin-right: 4px; padding: 2px 6px; border-radius: 3px; background-color: #4caf50; color: #fff; content: \'Supporter\'; } #cf .cf-powered-by::before { content: \' \'; color: rgba(0, 0, 0, 0.3); display: inline-block; } </style>';
      codeFundElement.querySelector('img[data-src="impression_url"]').src = 'https://codefund.io/display/5ae41c71-c6e5-4de8-812b-869d42c8c055.gif';
      codeFundElement.querySelectorAll('a[data-href="campaign_url"]').forEach(function (a) { a.href = 'https://codefund.io/impressions/5ae41c71-c6e5-4de8-812b-869d42c8c055/click?campaign_id=395&creative_id=362&property_id=441&template=bottom-bar&theme=light'; });
